"""migrate_drift_026_p2

Revision ID: 2c4a42b6d71
Revises: 100215e640c
...
revision = '2c4a42b6d71'
down_revision = '100215e640c'
branch_labels = None
depends_on = None
...
UP_MAP = {
    "ck_gamestates": ["create_date", "modify_date"],
    "ck_gamestateshistory": ["create_date", "modify_date"],
    "ck_player_events": ["create_date", "modify_date"],
    "ck_player_summary": ["create_date", "modify_date"],
    "ck_player_summaryhistory": ["create_date", "modify_date"],
    "ck_playercounters": ["last_update", "create_date", "modify_date"],
}
...
def upgrade_db():
    ...
    _rename_unique_constraint(
        "ck_playercounters",
        "ck_playercounters_counter_id_player_id_key",
        "uq_ck_playercounters_counter_id_player_id",
    )
